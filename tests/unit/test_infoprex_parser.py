...
def infoprex_mini_content():
    header = "CPR\tNOM\tLOCALIZACAO\tSAC\tPVP\tPCU\tDUC\tDTVAL\tCLA\tDUV\t" + "\t".join([f"V{i}" for i in range(15)]) + "\n"
    rows = [
        "1234567\tPROD1\tIlha\t10\t10.5\t8.0\t01/01/2026\t10/2026\tLAB1\t15/05/2026\t" + "\t".join(["1"]*15),
        "1234567\tPROD1\tColmeias\t5\t10.5\t8.0\t01/01/2026\t10/2026\tLAB1\t14/05/2026\t" + "\t".join(["0"]*15),
